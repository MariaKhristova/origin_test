...
if (firstDigit > secondDigit) Console.WriteLine($"Наибольше цифра числа {rndNum} => {firstDigit}");
else if (firstDigit < secondDigit) Console.WriteLine($"Наибольше цифра числа {rndNum} => {secondDigit}");
